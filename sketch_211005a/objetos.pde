void createButtoms()
{
  ...
  start = new Buttom(width/2-150, height/3, 300, 50, 10, #00ffff, 0, 9, #00d326, 0, (133), "START", 0, 255, 255, 0, 40, 90, (10), 1920/2+100, 1080/2+100);
  ...
  tutorial = new Buttom(width/2-150, height/3+100, 300, 50, 10, #00ffff, 0, 9, #00d326, 0, (133), "TUTORIAL", 200, 255, 0, 0, 40, 60, (2), 1920/2+100, 1080/2+100);
  ...
  siguiente = new Buttom(width/2-150, height/4, 300, 50, 10, #00ffff, 0, 9, #00d326, 0, (133), "SIGUIENTE", 0, 255, 255, 0, 40, 90, 10, 1920/2+100, 1080/2+100);
}
